...
<body>
    ...
    <div id="carousel-qhkt" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active" data-lg-img="${pageContext.request.contextPath}/static/image/jvm.jpg" data-xs-img="${pageContext.request.contextPath}/static/image/slide_01_768x410.jpg">
